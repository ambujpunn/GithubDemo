...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.repoName.text = [self.allRepos[indexPath.row] name];
    cell.owner.text = [self.allRepos[indexPath.row] ownerHandle];
    cell.myStars.text = [NSString stringWithFormat:@"%ld", (long)[self.allRepos[indexPath.row] stars]];
    cell.myForks.text = [NSString stringWithFormat:@"%ld", (long)[self.allRepos[indexPath.row] forks]];
    cell.repoDescription.text = [self.allRepos[indexPath.row] repoDescription];
    NSURL *url = [NSURL URLWithString:[self.allRepos[indexPath.row] ownerAvatarURL]];
